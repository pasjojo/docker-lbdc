...
<?php if($wl_theme_options['phone_no'] !='') { ?><li><i class="fa fa-phone"></i><a href="tel:<?php echo $wl_theme_options['phone_no']; ?>"><?php echo esc_attr($wl_theme_options['phone_no']); ?></a></li><?php } ?>
						<li><i class="fa fa-flag"></i><a href="/fr/"><img style="vertical-align:middle" src="/img/Flag_of_France.png"></a><a href="/en/"><img style="vertical-align:middle" src="/img/Flag_of_UK.png"></a></li>				</ul>
				<?php } ?>
					<!--ul class="social">
