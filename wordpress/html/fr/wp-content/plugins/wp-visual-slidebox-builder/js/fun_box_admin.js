jQuery(document).ready(function (e) {
        ...
        e(".edit").on("click", function () {
            ...
            if (typeof this.id != "undefined") {
                ...
                e.post(ajaxurl, n, function (t) {
                    ...
                    if (e('#square_preview').hasClass('sd_production_2')) {
                        e(".resp-type-select[value=sd_production_2]").attr('checked', 'checked');
                    } else if (e('#square_preview').hasClass('sd_production_3')) {
                        e(".resp-type-select[value=sd_production_3]").attr('checked', 'checked');
                    } else if (e('#square_preview').hasClass('sd_production_4')) {
                        e(".resp-type-select[value=sd_production_4]").attr('checked', 'checked');
                    } else if (e('#square_preview').hasClass('sd_production_in_div')) {
                        e(".resp-type-select[value=sd_production_in_div]").attr('checked', 'checked');
                    } else {
                        e(".resp-type-select[value=fixed]").attr('checked', 'checked');
                    }
                    if (e('#square_preview').find(".squareLitDemo").attr("entrance") == 1) {
                        e('#square-lit').css('top', (e('#square_preview').height() - 40));
                    }
                });
            }
        });
        ...
        e(".qPod").on("click", function () {
            ...
            switch (this.id) {
                case"qPodU":
                    t = t - 2;
                    console.log("UP", t)
                    e(".shape.squareDemo > .textArea").css("margin-top", t + 'px');
                    break;
                case"qPodL":
                    n = n + 2;
                    e(".shape.squareDemo > .textArea").css("margin-left", '-' + n + 'px');
                    break;
                case"qPodR":
                    n = n - 2;
                    e(".shape.squareDemo > .textArea").css("margin-left", '-' + n + 'px');
    ...
    e(".actionSave").on("click", function () {
        e('#square_preview').attr('dw', e('#square_preview').width()).attr('dh', e('#square_preview').height())
    ...
    e(".resp-type-select").on('change', function () {
        e('#square_preview').removeClass('sd_production_in_div sd_production_4 sd_production_3 sd_production_2');

        if (e(this).val() != 'fixed') {
            e('#square_preview').addClass(e(this).val());
        }
    });


    //update
    e("#remove_box_background_image").on('click', function (n) {
        n.preventDefault();

        e("#upload_image").val("");
        e("#square_preview").css({background: "transparent"});
    });

    e("#remove_lit_background_image").on('click', function (n) {
        n.preventDefault();

        e("#upload_image2").val("");
        e(".squareLitDemo.shape").css({background: "rgb(185, 184, 184)"});
    });
